...
module mips_simple_tb_sm();
  ...
  initial begin
    ...
    // Mostrar encabezado
    $display("\n==== MIPS Pipeline Testbench con Máquina de Estados ====\n");
    ...
    case(state)
      ...
      CHECK_END_STATE: begin
        if (halt) begin
          ...
          $display("$2=%0d (Esperado: 10)", register_values[2]);
          $display("$3=%0d (Esperado: 100)", register_values[3]);
          $display("$4=%0d (Esperado: 20)", register_values[4]);
          $display("$5=%0d (Esperado: 5)", register_values[5]);
          $display("$6=%0d (Esperado: 5)", register_values[6]);
          $display("$7=%0d (Esperado: 10)", register_values[7]);
          $display("$8=%0d (Esperado: 39)", register_values[8]);
          $display("$9=%0d (Esperado: 1)", register_values[9]);
          $display("$10=%0d", register_values[10]);
          $display("$11=%0d (Esperado: 5)", register_values[11]);
          $display("$12=%0d (Esperado: 10)", register_values[12]);
          $display("$13=%0d (Esperado: 0)", register_values[13]);
          $display("$14=%0d (Esperado: 7)", register_values[14]);
          $display("$15=%0d (Esperado: 20)", register_values[15]);
                 
          // Verificar memoria usando los valores leídos por debug
          $display("\nMemoria final:");
          $display("Mem[100]=%0d (Esperado: 5)", mem_values[0]);
          $display("Mem[104]=%0d (Esperado: 5)", mem_values[1]);
          $display("Mem[35]=%0d (Esperado: 15)", mem_values[2]);
          $display("Mem[39]=%0d (Esperado: 35)", mem_values[3]);
                 
          // Verificar resultado
          if (register_values[1] == 5 &&
              register_values[2] == 10 &&
              register_values[3] == 100 &&
              register_values[4] == 20 &&
              register_values[5] == 5 &&
              register_values[6] == 5 &&
              register_values[7] == 10 &&
              register_values[8] == 39 &&
              register_values[9] == 1 &&
              register_values[11] == 5 &&
              register_values[12] == 10 &&
              register_values[13] == 0 &&
              register_values[14] == 7 &&
              register_values[15] == 20 &&
              mem_values[0] == 5 &&
              mem_values[1] == 5 &&
              mem_values[2] == 15 &&
              mem_values[3] == 35) begin
  ...
  initial begin
    $dumpfile("mips_simple_sm.vcd");
    $dumpvars(0, mips_simple_tb_sm);
  end
